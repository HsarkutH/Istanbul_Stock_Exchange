...
"")
        ...
        icon1 = QIcon()
        icon1.addFile(u"iconlar/refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        self.refresh.setIcon(icon1)
        self.refresh.setIconSize(QSize(21, 21))
        ...
        icon2 = QIcon()
        icon2.addFile(u"iconlar/UserDelete.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"iconlar/LogOut.png", QSize(), QIcon.Normal, QIcon.Off)
