...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u"iconlar/Hamburger.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"iconlar/Account.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"iconlar/stock.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"iconlar/contact.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"iconlar/InformIcon.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u"iconlar/LogOut.png", QSize(), QIcon.Normal, QIcon.Off)
